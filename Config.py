...
def parse():
    p = argparse.ArgumentParser("MRHGNN: Enhanced Multimodal Relational Hypergraph Neural Network for Synergistic Drug Combination Forecasting", formatter_class = argparse.ArgumentDefaultsHelpFormatter)
